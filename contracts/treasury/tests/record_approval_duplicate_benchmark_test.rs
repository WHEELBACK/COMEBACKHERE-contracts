...
fn bench_duplicate_heavy_approvals_dedup() {
    ...
    let settlement_id = client.propose_settlement(&signers[0], &merchant, &1_000_000, &0_u64);
...
fn bench_compare_duplicate_heavy_vs_duplicate_free() {
    ...
    let sid_heavy = client_heavy.propose_settlement(&signers_heavy[0], &merchant_heavy, &1_000_000, &0_u64);
    ...
    let sid_free = client_free.propose_settlement(&signers_free[0], &merchant_free, &1_000_000, &0_u64);
